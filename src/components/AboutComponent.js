...
const initialMsg = () => "LMFAO is a chat app for the terminal.\n\nYou can use it to communicate with your friends and coworkers across the office or across the world.\n\nLMFAO protects user privacy by using end to end encryption to prevent anyone from reading user data while in transit. More importantly, it doesn't save any conversation.\n\nYou can join existing public channels or create your own new public or password-protected channels, which can each hold a maximum of 1,000 participants.\n\nType 'lmfao' in the command line in order to open the package's NPM page in another tab and learn more about it.";
